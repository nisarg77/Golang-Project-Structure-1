...
import (
	apiControllerV1 "Golang-Project-Structure-1/controllers/api/v1"
	apiControllerV2 "Golang-Project-Structure-1/controllers/api/v2"
	"Golang-Project-Structure-1/middlewares"
